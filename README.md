...
| Popup | Overlay | Cache |
| :---: | :---: | :---: |
| ![Extension popup with provider, language, and toggle controls](docs/screenshots/popup.png) | ![Translated Japanese subtitle overlaid on Prime Video](docs/screenshots/overlay.png) | ![Cache page listing translated titles, progress, and estimated cost](docs/screenshots/cache.png) |
